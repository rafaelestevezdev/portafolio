    ...
    >
      <div className="max-w-4xl mx-auto px-8 lg:px-12">
        ...
        <div className="space-y-8">
          {/* Experiencia 1 */}
          <div className="group relative pl-8 border-l-2 border-gray-300 dark:border-zinc-800 hover:border-gray-500 dark:hover:border-zinc-600 transition-colors duration-300">
            <div className="absolute w-4 h-4 bg-gray-300 dark:bg-zinc-800 group-hover:bg-gray-700 dark:group-hover:bg-white rounded-full -left-2 top-2 transition-colors duration-300"></div>
            <div className="pb-8">
